         ...
         <div class="card text-bg-dark border-primary mx-auto" style="width: auto;">
           ...
           <div class="card-body">
             ...
             <ul class="list-group list-group-flush">
                ...
                <li class="list-group-item text-bg-dark border-primary mx-auto"><a href="${item.wikipedia}" target="_blank" class="btn btn-secondary border border-primary">More information</a></li>                
             </ul>        
           </div>
